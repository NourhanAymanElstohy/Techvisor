...
<head>
    ...
    <link href="stylesheet" rel="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.css">
    <link href="stylesheet" rel="https://cdn.datatables.net/1.10.21/css/dataTables.bootstrap4.min.css">
	...
	<link rel="stylesheet" type="text/css" href="{{ url('design/style') }}/css/line-awesome-font-awesome.min.css">
	<link href="{{ url('design/style') }}/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
	<link rel="stylesheet" type="text/css" href="{{ url('design/style') }}/css/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="{{ url('design/style') }}/lib/slick/slick.css">
