            ...
            <div class="header-data">
                                ...
                                <div class="nott-list">
                                    ...
                                    <div class="notfication-details">
                                        <div class="noty-user-img">
                                            <img src="{{ url('design/style') }}/images/resources/circle-cropped.png"
                                                alt="">
                                        </div>
                                        <div class="notification-info">
                                            ...
                                            <h3><a
                                                    href="{{route('questions.show',['question'=> $notification->data['question_id']])}}">
                                                    {{$notification->data['user_name'] }} ask
                ...
                <div class="user-account">
                    ...
                    <div class="user-account-settingss" id="users">
                        ...
                        <ul class="on-off-status">
                            ...
                            <li>
                                <div class="fgt-sec">
                                    ...
                                    <small><a
                                            href="{{route('professionals.changestatus',Auth::user()->id)}}">Offline</a></small>
                                </div>
                            </li>
                            @else
                            <li>
                                <div class="fgt-sec">
                                    ...
                                    <small><a
                                            href="{{route('professionals.changestatus', $user->id)}}">Online</a></small>
                                </div>
                            </li>
                            @endif
                        </ul>
                        ...
                        <ul class="us-links">
                            @role('professional')
                            <li><a href="{{route('professionals.edit', Auth::user()->id)}}" title="">Account Setting</a>
                            </li>
                            @else
